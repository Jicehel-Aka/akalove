...
# Allemand : ä/ö/Ä/Ö annonces par le README mais absents ici (ü/ß deja presents plus haut) -- corrige.
# Meme technique que e/i/u trema (diaeresis_lower/diaeresis_upper), juste jamais ajoutes a l'origine.
...
# Allemand : ä/ö/Ä/Ö annonces par le README mais absents ici (ü/ß deja presents plus haut) --
# meme technique que ë/ï/ü (diaeresis_lower/upper), juste jamais ajoutes.
GLYPHS[0x00E4] = diaeresis_lower('a')   # ä
GLYPHS[0x00F6] = diaeresis_lower('o')   # ö
GLYPHS[0x00C4] = diaeresis_upper('A')   # Ä
GLYPHS[0x00D6] = diaeresis_upper('O')   # Ö
